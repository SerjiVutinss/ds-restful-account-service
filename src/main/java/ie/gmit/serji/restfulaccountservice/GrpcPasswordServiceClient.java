...
public class GrpcPasswordServiceClient {
    ...
    private final PasswordServiceGrpc.PasswordServiceFutureStub asyncPasswordService;
    ...
    private GrpcPasswordServiceClient() {
        ...
        asyncPasswordService = PasswordServiceGrpc.newFutureStub(channel);
    }
...
//        asyncPasswordService.
    ...
    public ListenableFuture<HashOutput> hashAsync(HashInput hashInput) {
        ...
        try {
            ...
            ListenableFuture<HashOutput> output =asyncPasswordService.hash(hashInput);
